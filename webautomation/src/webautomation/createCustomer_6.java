...
public class createCustomer_6 {
	public static void main(String[] args) {
		Createcustomer_m6.launchBrowser();
		Createcustomer_m6.navigate();
		Createcustomer_m6.login();
		Createcustomer_m6.minimizeFlyOutWindow();
		Createcustomer_m6.createcustomer();
		Createcustomer_m6.createproject();
		Createcustomer_m6.modifyproject();
		Createcustomer_m6.deleteproject();
		Createcustomer_m6.deletecustomer();    
		Createcustomer_m6.logout();
		Createcustomer_m6.closeApplication();
	}
